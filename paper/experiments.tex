...
% the qKG and qEI methods, the Matern52 kernel is used, and the GP
...
Table~\ref{tab:result_analytical}, when running in sequential mode (MACE-1 in Table~\ref{tab:result_analytical} and Figure~\ref{fig:CovPlotBenchmark}), the MACE
